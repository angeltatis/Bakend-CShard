...
namespace MasterApiTatis.Infraestructur.Context
{
    public class MyDbContext : DbContext
    {
        ...
        public DbSet<SerieNcf> seriesNcf { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Unidad>().HasIndex(u => u.desuni).IsUnique(true);
            modelBuilder.Entity<Producto>().HasIndex(p => p.despro).IsUnique(true);
